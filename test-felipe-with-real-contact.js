...
/**
 * Script melhorado para testar envio de mensagem para Felipe
 * 1. Busca contatos reais da API
 * 2. Procura pelo número do Felipe ou usa um contato válido
 * 3. Envia mensagem de teste
 */

async function testMessageToFelipeWithRealContact() {
  try {
    console.log('🧪 Iniciando teste avançado para Felipe Prado...');
    ...
    if (patients.length === 0) {
      ...
      return await testWithFakeButValidData(krolikClient);
    }
    ...
    // 4. Preparar e enviar mensagem
    console.log('\n4️⃣ Enviando mensagem de teste...');
    const payload = {
      number: targetPatient.phone,
      contactId: targetPatient.contactId,
      action_card_id: '631f2b4f307d23f46ac80a2b', // Action Card configurado
      forceSend: true
    };
...
/**
 * Teste com dados fictícios mas estruturalmente válidos
 */
async function testWithFakeButValidData(krolikClient) {
  console.log('\n🧪 Testando com dados estruturalmente válidos...');
...
// Executar teste
testMessageToFelipeWithRealContact();
